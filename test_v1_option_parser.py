...
from utils.option_code_parser import parse_option_code, get_option_type, get_expiry_date, get_strike_price, get_stock_code

def test_v1_option_parser():
    """测试V1系统期权代码解析器"""
